...
import com.itp.sgc.repository.ElementosRepository;
...
public class ElementosResourceIT {
    ...
    public void setup() {
        ...
        final ElementosResource elementosResource = new ElementosResource(elementosRepository);
     ...
     * if they test an entity which requires the current entity.
     */
    public static Elementos createUpdatedEntity(EntityManager em) {
        Elementos elementos = new Elementos()
    ...
    public void createElementos() throws Exception {
        ...
        assertThat(testElementos.getDescripcion()).isEqualTo(DEFAULT_DESCRIPCION);
    }
    ...
    public void updateElementos() throws Exception {
        ...
        assertThat(testElementos.getDescripcion()).isEqualTo(UPDATED_DESCRIPCION);
    }
